...
const DB = {
  ...
  init() {
    ...
    const products = [
      ...
      { name: 'Pastel de Carne', category: 'Comidas', price: 10.00, cost: 4.00, stock: 60, minStock: 10, unit: 'un', emoji: '🥟' },
      { name: 'Pastel de Queijo', category: 'Comidas', price: 10.00, cost: 4.00, stock: 60, minStock: 10, unit: 'un', emoji: '🥟' },
      { name: 'Coxinha', category: 'Comidas', price: 8.00, cost: 3.00, stock: 50, minStock: 10, unit: 'un', emoji: '🍗' },
      { name: 'Risole', category: 'Comidas', price: 8.00, cost: 3.00, stock: 50, minStock: 10, unit: 'un', emoji: '🥟' },
      { name: 'Porcão de Batata Frita', category: 'Comidas', price: 30.00, cost: 12.00, stock: 50, minStock: 10, unit: 'un', emoji: '🍟' },
      { name: 'Frango à Passarinho', category: 'Comidas', price: 45.00, cost: 18.00, stock: 30, minStock: 5, unit: 'un', emoji: '🍗' },
      { name: 'Bolinho de Bacalhau', category: 'Comidas', price: 28.00, cost: 10.00, stock: 40, minStock: 8, unit: 'un', emoji: '🧆' },
      { name: 'Calabresa Acebolada', category: 'Comidas', price: 38.00, cost: 14.00, stock: 25, minStock: 5, unit: 'un', emoji: '🥩' },
